...
**Every row is a measurement, not an impression.** The `evidence` column names a file or work
directory that still contains the error text or the numbers quoted. If you cannot point at
